...
export default function PortalCommunityGroupDirectPage() {
  ...
  useEffect(() => {
    ...
    async function loadData() {
      try {
        ...
        // 3. Match community by slug or ID
    ...
    return (
      <div style={{
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ fontSize: '14px', fontWeight: '700' }}>Loading Community Group...</div>
