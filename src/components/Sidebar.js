  ...
  return (
    <nav id="sb" className={`${collapsed ? 'collapsed' : ''} ${mobileMenuOpen ? 'mobile-open' : ''}`}>
      ...
      <div className="sb-foot">
        {/* Mobile-only Settings Panel inside Sidebar */}
        {!collapsed && typeof window !== 'undefined' && window.innerWidth <= 768 && (
          <div style={{
            ...
            <div style={{
              ...
              <span style={{ fontWeight: 'bold' }}>🇪🇬 {isRtl ? 'صرف الجنيه:' : 'EGP Exchange:'}</span>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', textAlign: isRtl ? 'right' : 'left' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                <label style={{ fontSize: '10.5px', color: 'var(--t3)', fontWeight: 'bold' }}>{isRtl ? '🌐 اللغة:' : '🌐 Language:'}</label>
              ...
              {/* Theme Switcher */}
              <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                <label style={{ fontSize: '10.5px', color: 'var(--t3)', fontWeight: 'bold' }}>{isRtl ? '🎨 المظهر:' : '🎨 Theme:'}</label>
                <div className="lang-sw" style={{ width: '100%', display: 'flex' }}>
                  <button
            ...
            {/* Currency Selector */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', textAlign: isRtl ? 'right' : 'left' }}>
              <label style={{ fontSize: '10.5px', color: 'var(--t3)', fontWeight: 'bold' }}>{isRtl ? '💵 العملة:' : '💵 Currency:'}</label>
              <select
                className="inp"
                style={{
                  padding: '6px 8px',
